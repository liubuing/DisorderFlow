    ...
    def run(self, initial_pdb: str, design_region: str = 'A:10-30',
        ...
        for round_idx in range(1, self.max_rounds + 1):
            ...
            if filtered:
                ...
                interface_scores = [r['iptm'] for r in filtered if r.get('iptm') is not None]
                avg_iptm = (sum(interface_scores) / len(interface_scores)
                            if interface_scores else None)
