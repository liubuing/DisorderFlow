...
from disorderflow.modules.common.geometry import reconstruct_backbone_partially
from disorderflow.modules.common.so3 import so3vec_to_rotation
from disorderflow.utils.inference import RemoveNative
from disorderflow.utils.protein.writers import save_pdb
from disorderflow.utils.train import recursive_to
from disorderflow.utils.misc import *
from disorderflow.utils.data import *
from disorderflow.utils.transforms import *
from disorderflow.utils.inference import *
from disorderflow.tools.renumber import renumber as renumber_antibody
...
def args_from_cmdline():
    ...
    parser.add_argument('-d', '--device', type=str, default='cuda' if torch.cuda.is_available() else 'xpu' if hasattr(torch, 'xpu') and torch.xpu.is_available() else 'cpu')
