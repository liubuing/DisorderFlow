...
from disorderflow.modules.common.geometry import global_to_local, local_to_global, normalize_vector, construct_3d_basis, angstrom_to_nm
from disorderflow.modules.common.layers import mask_zero, LayerNorm
...
class GABlock(nn.Module):
    ...
    def __init__(self, node_feat_dim, pair_feat_dim, value_dim=32, query_key_dim=32, num_query_points=8,
                 num_value_points=8, num_heads=12, bias=False, dropout=0.0):
        super().__init__()
...
class GAEncoder(nn.Module):
    ...
    def __init__(self, node_feat_dim, pair_feat_dim, num_layers, ga_block_opt={}, dropout=0.0):
        super(GAEncoder, self).__init__()
        self.blocks = nn.ModuleList([
            GABlock(node_feat_dim, pair_feat_dim, dropout=dropout, **ga_block_opt)
