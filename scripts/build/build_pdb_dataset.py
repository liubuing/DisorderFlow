...
from build_utils import AA3_TO_1, AA_LETTERS, compute_ptm_from_pae, load_pdb_sequence, save_lmdb, split_and_save_entries
...
def main():
    ...
    split_and_save_entries(results, output_dir, train_split=0.8, seed=2026)
